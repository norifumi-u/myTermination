...
public final class MyTermination_M_2 extends org.scribble.runtime.statechans.ReceiveSocket<MyTermination, M> implements Receive_M_T_result_Int<EndSocket> {
	...
	public myTermination.MyTermination.statechans.M.EndSocket async(T role, result op, org.scribble.runtime.util.Buf<MyTermination_M_2_Future> arg) throws org.scribble.main.ScribRuntimeException {
		arg.val = new MyTermination_M_2_Future(super.getFuture(MyTermination.T));
		this.se.setCompleted();
		return new EndSocket(this.se, true);
	}
	...
	public myTermination.MyTermination.statechans.M.EndSocket async(T role, result op) throws org.scribble.main.ScribRuntimeException {
		return async(MyTermination.T, op, (org.scribble.runtime.util.Buf<MyTermination_M_2_Future>) this.se.gc);
	}
}